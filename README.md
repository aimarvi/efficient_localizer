...
The stimuli used for the study are provided in the [stims](https://github.com/aimarvi/efficient_localizer/tree/main/stims) folder. We recommend running at least three runs of EMFL to reproduce the results we show in the paper, in any order. 
